                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            ...
                            <li ><a href="liste_formation.php">Formation</a></li>
		  ...
		  <form method="POST">';
			...
			<tbody>';
				...
				<tr>
				  ...
				  <td><?=$row['Thème']?></td>
				   <td>
                        <a href="ajouter_formation.php"><span class="glyphicon glyphicon-plus"/></a>
                        <a href="modifier_formation.php"><span class="glyphicon glyphicon-pencil"/></a>
                        <? echo '<a href="Supprimer_formation.php?idee='.$row['Code_Form'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
