      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
                ...
                <div>
                    ...
                    <ul>
                             <li ><a href="../../Bibliotheque/Liste_bibliotheque1.php">Liste des Bibliotéques</a></li>
                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            ...
                            <li ><a href="Liste_Region1.php">Region</a></li>
                            <li ><a href="../Cadre/liste_cadre.php">Cadre</a></li>
                            <li ><a href="../Diplome/liste_diplome.php">Diplome</a></li>                            
                            <li ><a href="../Formation/liste_formation.php">Formation</a></li>
                            <li ><a href="../Problème/liste_probleme.php">Problème</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Liste des Regions :</h1>
          ...
          <div class="row placeholders">';
			...
			<tbody>';
				...
				?>
				<tr>
				  <td><?=$row['Code_Region']?></td>
				  <td><?=$row['Nom_Region']?></td>
				    
					<td>
                        <a href="Ajouter_Region.php"><span class="glyphicon glyphicon-plus"/></a>
                        <a href="Modifier_Region.php"><span class="glyphicon glyphicon-pencil"/></a>
                        <? echo '<a href="Supprimer_Region.php?idee='.$row['Code_Region'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
