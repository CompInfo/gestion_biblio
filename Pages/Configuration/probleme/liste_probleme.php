    ...
    <div class="container-fluid" Style="margin-top:60px;">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
		   <section class="ac-container">
				...
				<div>
					...
					<article class="ac-large">
						<ul>
							<li ><a href="../Liste_centre1.php">Liste</a></li>
				...
				<div>
					...
					<article class="ac-large">
						<ul>
							<li ><a href="../../Responsable/Liste_responsable.php">Liste</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Liste des problémes : </h1>
		...
		<table id="datatables" class="display">
			...
			<tbody>';
				...
				$req="SELECT problème.Num_pb,problème.Problème,problème.Solution,centre_bibliotheque.Nature_Espace FROM  problème,centre_bibliotheque WHERE problème.Code_Centre=centre_bibliotheque.Code_Centre";
				$res = mysql_query($req);
				...
				<tr>Solution
				  ...
				  <a href="ajouter_probleme.php"><span class="glyphicon glyphicon-plus"/></a>
                  <a href="modifier_probleme.php"><span class="glyphicon glyphicon-pencil"/></a>
                  <? echo '<a href="Supprimer_probleme.php?idee='.$row['Num_pb'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
