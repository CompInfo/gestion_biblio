      ...
      <div class="row">
		...
		<section class="ac-container" Style="margin-top:55px;">
		 ...
		 <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Modifier Un problémes : </h1>
...
<form method="POST" action="traitement_modifier.php"><table>

							
					<tr><td> Num_pb :</td><td><select name="numpb">
							';
							include("../../../connexion/connexion1.php");
							$req="SELECT * FROM  `problème` ";
							$res = mysql_query($req);
							while($data=mysql_fetch_array($res)){
							echo '<option value="'.$data[0].'" >'.$data['Num_pb'].'</option>';}
							
							


echo '</td></tr>
<tr> <td>Probléme :</td><td> <input type ="text" name="probleme"></td></tr>
 <tr><td>Solution :</td><td> <input type ="text" name="solution"></td></tr>
<tr><td></td><td><input class="bouton" type ="submit" value="Modifier" name="modifier">
<input class="bouton" type ="submit" value="retour" name="retour"></td></tr>
</table>
