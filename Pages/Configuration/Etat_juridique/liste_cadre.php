    ...
    <div class="container-fluid" Style="margin-top:60px;">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            ...
                            <li ><a href="liste_cadre.php">Cadre</a></li>
          ...
          <h1 class="page-header">Liste des Cadres</h1>
	...
	<form method="POST">
		<table id="datatables" class="display">
			...
			<tbody>';
				...
				<tr>
				  <td><?=$row['Code_Cadre']?></td>
				  <td><?=$row['Echelle']?></td>
				  <td>
				  
				  <a href="ajouter_cadre.php"><span class="glyphicon glyphicon-plus"/></a>
                  <a href="modifier_cadre.php"><span class="glyphicon glyphicon-pencil"/></a>
                  <? echo '<a href="Supprimer_cadre.php?idee='.$row['Code_Cadre'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
