...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="../../../css/style/demos.css">
  ...
  <body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Modifer un Diplome :</h1>
          ...
          <div class="row placeholders">
				<form method="POST" action="traitement_Modif.php" >
					<table>
							...
							$req="SELECT Num_Dip FROM diplome";
							$res = mysql_query($req);
							while($data=mysql_fetch_array($res)){
								echo '<option value="'.$data[0].'" >'.$data['Num_Dip'].'</option>';}
								echo'</td>
							</tr>
							<tr>
								<td> Specialite:</td>
