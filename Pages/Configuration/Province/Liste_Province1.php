    ...
    <div class="container-fluid" Style="margin-top:60px;">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Liste des Provinces :</h1>
          ...
          <div class="row placeholders">';
			...
			<tbody>';
				...
				$req="SELECT * FROM  `province` INNER JOIN région ON (province.Code_Region=région.Code_Region ) ";
				...
				?>
				<tr>
				  <td><?=$row['Code_Province']?></td>
				  <td><?=$row['Nom_Province']?></td>
				   <td><?=$row['Nom_Region']?></td>
				    
					<td>
                        <a href="Ajouter_Province.php"><span class="glyphicon glyphicon-plus"/></a>
                        <a href="Modifier_Province.php"><span class="glyphicon glyphicon-pencil"/></a>
                        <a href="Supprimer_Province.php"><span class="glyphicon glyphicon-remove"/></a>
