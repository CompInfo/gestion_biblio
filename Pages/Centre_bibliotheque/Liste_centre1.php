    ...
    <div class="container-fluid" Style="margin-top:60px;">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
		 <section class="ac-container">
                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            <li ><a href="Liste_centre1.php">Liste des Centre bibliotheque</a></li>
        ...
        <div class=" page-content inset" Style="margin-left:300px;margin-right:50px;margin-top:50px;">
          <h1 class="page-header">Liste des Centres :</h1>


<div Style="float:right;">
<a href="ajouter_centre.php" type="button" class="btn btn-primary">Nouveau Centre </a>
    ...
    <div class="modal fade" id="largeModal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
      <div class="modal-dialog modal-lg">
		...
		$req="SELECT centre_bibliotheque.Code_Centre,centre_bibliotheque.Nature_Espace,bibliothèque.Nom_Bibli FROM centre_bibliotheque, bibliothèque WHERE centre_bibliotheque.Code_Bibl=bibliothèque.Code_Bibl";
				$res = mysql_query($req);
				while($row = mysql_fetch_array($res)){
				?>
				<tr>
				  <td><?=$row['Code_Centre']?></td>
				  <td><?=$row['Nature_Espace']?></td>
				 <td><?=$row['Nom_Bibli']?></td>
						
				  <td>
            <a href="<?php echo "Modifier_centre.php?var2=".$row['Code_Centre']."" ?>"  data-toggle="modal" data-target="#largeModal" ><span class="glyphicon glyphicon-pencil"/></a>
                                <? echo '<a href="Supprimer_centre.php?idee='.$row['Code_Centre'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
				  </td>
				</tr>
				 <?
				 }
