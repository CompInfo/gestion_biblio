    ...
    <div class="container-fluid" Style="margin-top:60px;">
      <div class="row">
        ...
        <div class=" page-content inset" Style="margin-left:300px;margin-right:50px;margin-top:50px;">
          <h1 class="page-header">Liste des Responsables :</h1>
			...
			<tr>
		        ...
		        <th>Adresse Responsabe</th>
				<th>Code Bibliotéque</th>
				<th>Operation </th>
			...
			<tbody>';
				...
				$req="SELECT responsable.Code_resp,responsable.Nom_resp,responsable.الاسم_النسب,responsable.Tel_resp,responsable.Adresse_resp,bibliothèque.Nom_Bibli FROM  responsable , bibliothèque WHERE responsable.Code_bibl =bibliothèque.Code_bibl ";
				...
				<tr>
				  ...
				  <td><?=$row['Tel_resp']?></td>
				  <td><?=$row['Adresse_resp']?></td>
				  <td><?=$row['Nom_Bibli']?></td>
<td>
				  
				  <a href="ajouter_responsable.php"><span class="glyphicon glyphicon-plus"/></a>
                  <a href="modifier_responsable.php"><span class="glyphicon glyphicon-pencil"/></a>
                  <? echo '<a href="Supprimer_responsable.php?idee='.$row['Code_resp'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
