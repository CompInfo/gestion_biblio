    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
		    <section class="ac-container" >
				...
				<div>
					...
					<article class="ac-large">
						<ul>
							<li ><a href="Liste_visiteur1.php">Liste</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Modifier Visiteur:</h1>
...
<tr>
		<td> Code Visiteur : </td>
			...
			while($line=mysql_fetch_array($result)){
			 echo' <option value="'.$line[0].'">'.$line['Code_v'].'</option>';
			 }
...
<tr>
<td> الاسم: </td><td><input type ='text' name='prenom_arab'></td>
</tr>
<tr>
<td> النسب: </td><td><input type ='text' name='nom_arab'></td>
</tr>
<tr>
...
<td> Nbr Livre Emprunter :</td><td><input type ='text' name='nbr_livre_emprunter'></td>
</tr>
<tr>
<td></td><td><input class='bouton' type ='submit' value='Modifier' name='modifier'>
