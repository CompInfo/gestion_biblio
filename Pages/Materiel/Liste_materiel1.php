      ...
      <div class="row">
		...
		<section class="ac-container">
                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            <li ><a href="Liste_materiel1.php">Liste des Materiaux</a></li>
        ...
        <div class=" page-content inset" Style="margin-left:300px;margin-right:50px;margin-top:50px;">
          <h1 class="page-header">Liste des Materiels : </h1>


<div Style="float:right;">
<a href="ajouter_materiel.php" type="button" class="btn btn-primary">Nouveau Materiel </a>
          ...
          <div class="modal-footer">
			...
			<tbody>';
				...
				<tr>
				  <td><?=$row['Code_Mat']?></td>
				  <td><?=$row['Nom_Mat']?></td>
				 <td><?=$row['Qt_utilisée']?></td>
				 <td><?=$row['Observation']?></td>
						
						
				  <td>

            <a href="<?php echo "Modifier_materiel.php?var2=".$row['Code_Mat']."" ?>"  data-toggle="modal" data-target="#largeModal" ><span class="glyphicon glyphicon-pencil"/></a>
				                <? echo '<a href="Supprimer_materiel.php?idee='.$row[0].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
                  </td>
				</tr>
				 <?
				 }
