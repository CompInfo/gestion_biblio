    ...
    <div class="container-fluid" Style="margin-top:60px;">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
                ...
                <div>
                    ...
                    <ul>
                            ...
                            <li ><a href="../Bibliotheque/Province/Region/Liste_Region1.php">Région</a></li>
                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            <li ><a href="Liste_documentation1.php">Liste</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h1 class="page-header">Modifier une Documentation</h1>
		...
		<tr>
		<td> Code :</td>
		<td><select name='code_docum'>";
					
					include("../../connexion/connexion1.php");
					$req="SELECT * FROM documentation";
					$res=mysql_query($req);
					
					while($line1=mysql_fetch_array($res)){
					echo'<option value="'.$line1[0].'">'.$line1[0].'</option>';}
					echo"</td>
		</tr>
		<tr>
		<td>Langue :</td>
		...
		<tr>
		<td>Nbr_Livre :</td>
		<td><input type ='text' name='nbr_livre'></td>
		</tr>
		<tr>
		<td>Nbr_Livre par tome: </td>
		<td><input type ='text' name='nbr_livre_tome'></td>
		</tr>
		<tr>
		<td>Nbr_copie_livre :</td>
		<td><input type ='text' name='nbr_copie_livre'></td>
		</tr>
		<tr>
		<td>Nbr Livre Titre :  </td>
		<td><input type ='text' name='Nb_livre_titre'></td>
		</tr>
		<tr>
		<td>Etat : </td>
		...
		<tr>
		<td>Evolution :</td>
		<td><input type ='text' name='evolution'></td>
		</tr>
		<tr>
		<td> Objet : </td>
