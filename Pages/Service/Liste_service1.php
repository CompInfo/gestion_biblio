...
<script src="../../js/jquery.dataTables.js" type="text/javascript"></script>
  ...
  <section class="ac-container">
                ...
                <div>
                    ...
                    <article class="ac-large">
                        <ul>
                            <li ><a href="Liste_service1.php">Liste des Services</a></li>
        ...
        <div class=" page-content inset" Style="margin-left:300px;margin-right:50px;margin-top:50px;">
          <h1 class="page-header">Liste Des Services :</h1>
			...
			<tr>
				<th>Code Service</th>
				<th>Nom Service</th>
				<th>Methode Recherche</th>
				<th>Type Emprunt</th>
				<th>Outil Recherche </th>
				<th> Document </th>
				<th>Operation</th>
			</tr>
			</thead>
			<tbody>';
				...
				$req="SELECT services.Code_serv,services.Nom_serv,services.Méthode_recherche,services.Type_Emprunt,services.Outils_recherche,documentation.Objet FROM services ,documentation WHERE services.Code_Doc=documentation.Code_Doc";
				...
				<tr>
				  <td><?=$row['Code_serv']?></td>
				<td><?=$row['Nom_serv']?></td>
				<td><?=$row['Méthode_recherche']?></td>
				<td><?=$row['Type_Emprunt']?></td>   
                <td><?=$row['Outils_recherche']?></td>		
				<td><?=$row['Objet']?></td>
						
				  
				  <td>
				  
				  <a href="ajouter_service.php"><span class="glyphicon glyphicon-plus"/></a>
                  <a href="modifier_service.php"><span class="glyphicon glyphicon-pencil"/></a>
                  <? echo '<a href="Supprimer_service.php?idee='.$row['Code_serv'].'"><span class="glyphicon glyphicon-remove"/></a>'; ?>
